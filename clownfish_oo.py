...
patrick = Icon("images/patrickStar.png",(0,10),(240,255),(0,10),40,40,fish_tank.total_columns,fish_tank.total_rows)
clownfish.setSlowdown(2)
clownfish2.setSlowdown(3)
patrick.setSlowdown(3)
fish_tank.add_icon(patrick)
