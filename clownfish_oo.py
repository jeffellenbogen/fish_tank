...
clownfish2 = Icon("images/clownfish.jpg",(0,10),(200,255),(0,10),24,15,fish_tank.total_columns,fish_tank.total_rows)
seaTurtle = Icon("images/seaTurtle.jpg",(0,10),(0,10),(150,255),80,50,fish_tank.total_columns,fish_tank.total_rows)
seahorse = Icon("images/seahorse.png",(0,10),(240,255),(0,10),40,40,fish_tank.total_columns,fish_tank.total_rows)
clownfish.setSlowdown(random.randint(0,2)
clownfish2.setSlowdown(random.randint(0,4))
seahorse.setSlowdown(random.randint(2,5))
